...
class chaseQuery{
    ...
    elements={
       ...
       pageDropDownValue: () => cy.xpath("//span[normalize-space()='10']"),
       ...
       commercial:()=>cy.contains('li','Commercial'),
       ...
       lobDropDown:()=>cy.contains('li','Commercial'),
...
verifyTinTable()
{
    this.elements.tinColumn().should('be.visible').and('includes.text','TIN')
}
